...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory",basePackages = {
		"com.satish.repository.UserRepository"},transactionManagerRef = "transactionManager")
public class UserDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder, @Qualifier("datasource")DataSource dataSource) {
		...
		return builder.dataSource(dataSource).properties(properties).packages("com.satish.model").persistenceUnit("User").build();
	}
